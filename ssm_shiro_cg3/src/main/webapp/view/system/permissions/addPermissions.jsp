	...
	<div class="panel admin-panel">
		...
		<div class="body-content">
			<form method="post" class="form-x"
				action="<%=basePath%>permissionsController/add.do">
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50" value="" name="permissionsName"
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50" value="" name="permissionsDesc"
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50" value="" name="permissionsUrl"
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50" value="" name="percode"
							data-validate="required:请输入状态" />
						<div class="tips"></div>
					</div>
				</div>
